            ...
            <div class="main">
                ...
                <main class="content">
                    <div class="container-fluid p-0">
                        <app-welcome v-if="FocusView.onWelcome"></app-welcome>
...
app.component('app-welcome',{
    ...
    <div class="row">
        <div class="col-12 col-sm-12 col-md-12 col-xl-12 card mb-3 text-center">                        
           <span class="text-muted h3"> {{ this.$parent.Welcome }}</span>
           <img src= "./img/logo_welcome.jpg" style="border-radius:20%;" />
        </div>
    </div>
    `,
})