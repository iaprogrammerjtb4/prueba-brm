app.component('app-profile',{
    ...
    <div class="row">
        <div class="col-12 col-sm-12 col-md-12 col-xl-12 card mb-3 text-center">                        
            <h3 class="h-3 text-muted mb-0"><b>Editar credenciales</b></h3>                                      
            <div class="card-body">
                <img :src="userPhoto" :alt="user" class="img-fluid rounded-circle mb-2" width="128" height="128" />
                <h5 class="card-title mb-0">{{ user }}</h5>
                <div class="text-muted mb-2">{{ rol }}</div>
            </div>
